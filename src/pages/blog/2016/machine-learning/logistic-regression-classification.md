...
\end{align}
$$
![Logistic function](./images/Logistic_function.svg)
...
![Logistic regression cost function positive class](./images/logistic_regression_cost_function_positive_class.png)
